...
describe('streamCompletion', () => {
  ...
  it('should handle JSON parse errors gracefully and continue', async () => {
      const validResponse1: CompletionResult = { text: 'Valid 1', isComplete: false };
      const validResponse2: CompletionResult = { text: 'Valid 2', isComplete: true };
  ...
  it('should parse chunks that are split across reader boundary', async () => {
      const mockResponse: CompletionResult = { text: 'Split JSON', isComplete: true };
