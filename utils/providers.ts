...
// Provider marks are served from this origin. Opening the app makes no
// third-party request; see public/provider-icons/README.txt for provenance.
const ICON = (slug: string) => `/provider-icons/${slug}.svg`;
